...
export default function CTAHero({ title, subtitle, text, link, bgimage, bgimagealt, buttontext, slidingtexts }: any) {
  ...
  return (
    <>
      <div className="overflow-hidden flex flex-col justify-center relative min-h-[100vh] pb-10 pt-16 bg-opacity-20 nav-gap">
        <Image
          src={bgimage}
          alt={bgimagealt}
          fill={true}
        ...
        <div className="relative flex flex-col gap-4 w-11/12 lg:w-8/12 m-auto ">
          <div className="flex flex-col justify-center gap-4 lg:w-2/3 h-full text-white pb-16">
            <h2 className="text-sm lg:text-md font-bold tracking-widest uppercase text-white">{subtitle}</h2>
            <h1 className="text-6xl lg:text-7xl font-black tracking-tighter text-white">{title}</h1>
        ...
        <div className='employers-slide hidden lg:flex flex-nowrap w-[200vw] z-10'>
          <div className='flex justify-evenly gap-16 h-full w-[100vw] text-white'>
