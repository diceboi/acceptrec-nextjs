...
const ManualHandlingHero: React.FC<ManualHandlingProps> = ({ title, subtitle, classname }) => {
  return (
    <>

      <div className={classname}>
        <div className="relative flex flex-col justify-end gap-4 w-11/12 lg:w-8/12 min-h-[30vh] m-auto bg-[url('/manualhandling.webp')] bg-contain bg-bottom bg-no-repeat nav-gap">
...
export default ManualHandlingHero;