interface CandidateOfTheMonthHeroProps {
    title: string;
    subtitle: string;
    classname: string;
  }
  ...
  const CandidateOfTheMonthHero: React.FC<CandidateOfTheMonthHeroProps> = ({ title, subtitle, classname}) => {
    return(
        ...
        <div className={classname}>
            <div className="relative flex flex-col justify-end gap-4 w-11/12 lg:w-8/12 min-h-[30vh] py-10 m-auto bg-[url('/candidateofthemonthhero.webp')] bg-contain bg-bottom bg-no-repeat">
