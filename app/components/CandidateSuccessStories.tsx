            ...
            <div className='relative w-11/12 h-max lg:w-8/12 m-auto py-10'>
                ...
                >
                    ...
                    <SwiperSlide className='w-10/12'>
                        <div className='group flex flex-col lg:flex-row gap-4 p-4 lg:min-h-[30vh] rounded-3xl shadow-special bg-white w-full mb-16'>
                            <div className='relative flex flex-col justify-end p-4 lg:w-1/2 min-h-[30vh] bg-[url("/jake-wilson.webp")] rounded-2xl bg-cover bg-right bg-no-repeat h-auto'>
                            </div>
                    ...
                    <SwiperSlide >
                        <div className='group flex flex-col lg:flex-row gap-4 p-4 lg:min-h-[30vh] rounded-3xl shadow-special bg-white w-full mb-16'>
                            <div className='relative flex flex-col justify-end p-4 lg:w-1/2 min-h-[30vh] bg-[url("/claire.webp")] rounded-2xl bg-cover bg-right bg-no-repeat h-auto'>
                            </div>
                            <div className='flex flex-col lg:w-1/2 gap-4 p-4'>
