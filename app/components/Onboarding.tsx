    ...
    <section className="relative py-20 bg-neutral-100">
            <div className='flex flex-col w-11/12 lg:w-8/12 gap-8 m-auto'>
                ...
                <ul className="grid lg:grid-cols-2 w-full">
                    ...
                    <li id="onboarding-list-left" className="relative lg:border-r lg:border-neutral-300 lg:pr-16 mt-20 lg:mt-0 lg:pt-20 before:content-['1']">
                        <div className="flex flex-col justify-center p-4 w-full min-h-[20vh] bg-white rounded-3xl shadow-highlights">
                            <h2 className="text-2xl font-black tracking-tighter text-[#312252] w-10/12 lg:w-full">Client confirmation</h2>
                    ...
                    <li id="onboarding-list-right" className="relative lg:pl-16 lg:pt-60 pt-20 before:content-['2']">
                        <div className="flex flex-col justify-center p-4 w-full min-h-[20vh] bg-white rounded-3xl shadow-highlights">
                            <h2 className="text-2xl font-black tracking-tighter text-[#312252] w-10/12 lg:w-full">Contract update</h2>
                    ...
                    <li id="onboarding-list-left" className="relative lg:border-r lg:border-neutral-300 mt-20 lg:mt-0 lg:pr-16 before:content-['3']">
                        <div className="flex flex-col justify-center p-4 w-full min-h-[20vh] bg-white rounded-3xl shadow-highlights">
                            <h2 className="text-2xl font-black tracking-tighter text-[#312252] w-10/12 lg:w-full">Credit assessment</h2>
                            <p>Prior to any joint ventures, we ascertain the sustainability of the proposed strategy and feedback accordingly.</p>
                        </div>
                    </li>

                    <li id="onboarding-list-right" className="relative lg:pl-16 lg:pt-40 pt-20 before:content-['4']">
                        <div className="flex flex-col justify-center p-4 w-full min-h-[20vh] bg-white rounded-3xl shadow-highlights">
                            <h2 className="text-2xl font-black tracking-tighter text-[#312252] w-10/12 lg:w-full">Partnership set-up</h2>
                    ...
                    <li id="onboarding-list-left" className="relative lg:border-r lg:border-neutral-300 mt-20 lg:mt-0 lg:pr-16 before:content-['5']">
                        <div className="flex flex-col justify-center p-4 w-full min-h-[20vh] bg-white rounded-3xl shadow-highlights">
                            <h2 className="text-2xl font-black tracking-tighter text-[#312252] w-10/12 lg:w-full">Welcome Pack</h2>
                    ...
                    <li id="onboarding-list-right" className="relative lg:pl-16 lg:pt-40 pt-20 before:content-['6']">
                        <div className="flex flex-col justify-center p-4 w-full min-h-[20vh] bg-white rounded-3xl shadow-highlights">
                            <h2 className="text-2xl font-black tracking-tighter text-[#312252] w-10/12 lg:w-full">Client introductory meetings</h2>
                    ...
                    <li id="onboarding-list-left" className="relative lg:border-r lg:border-neutral-300 mt-20 lg:mt-0 lg:pr-16 before:content-['7']">
                        <div className="flex flex-col justify-center p-4 w-full min-h-[20vh] bg-white rounded-3xl shadow-highlights">
                            <h2 className="text-2xl font-black tracking-tighter text-[#312252] w-10/12 lg:w-full">Account form</h2>
