    ...
    <section className="w-full py-20">
        <div className="flex flex-col gap-8 w-11/12 lg:w-8/12 m-auto">
            <div className="flex items-center gap-20 pb-20">
                <div className="lg:w-1/2 h-[40vh] bg-[url('/referafriendinner.webp')] bg-center bg-cover bg-no-repeat rounded-3xl">
                </div>
            ...
            <div className="flex items-center gap-20 pb-20">
                ...
                <div className="lg:w-1/2 h-[40vh] bg-[url('/referafriendinner2.webp')] bg-center bg-contain bg-no-repeat rounded-3xl">
                </div>                
            </div>
            <div className="flex flex-col items-center w-full">
                ...
                <div className="flex w-full py-20">
                    <div className="flex flex-col gap-8 items-center justify-center">
                        ...
                        <p className="w-1/2 text-center">£50 worth of voucher will be given to you for every worker that goes on to complete 150 hours with Accept Recruitment! Do you know someone looking for work in Leicestershire or Yorkshire?</p>
                    </div>
                    <div className="flex flex-col gap-8 items-center justify-center">
                        <h3 className="w-1/2 bg-[#00afaa] rounded-3xl text-5xl text-center text-white font-black p-8 shadow-special">£100</h3>
                        <p className="w-1/2 text-center">Referral paid to you if you recommend a vacancy to Accept Recruitment! Do you know someone recruiting for temporary or permanent staff within the Warehouse, Driving or Logistics?</p>
                    </div>
