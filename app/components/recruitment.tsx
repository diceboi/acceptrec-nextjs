    ...
    return(
        ...
        <section className="w-full py-20 bg-gradient-to-b from-white to-neutral-100">
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center gap-8 w-11/12 lg:w-8/12 m-auto">
                ...
                <Link href="/for-employers" className="recruitment-tile group flex flex-col w-full lg:w-1/3 rounded-3xl hover:shadow-special hover:bg-white cursor-pointer ease-out duration-200">
                ...
                <Link href="/for-candidates" className="recruitment-tile group flex flex-col w-full lg:w-1/3 rounded-3xl hover:shadow-special hover:bg-white cursor-pointer ease-out duration-200">
                ...
                <Link href="/register" className="recruitment-tile group flex flex-col w-full lg:w-1/3 rounded-3xl hover:shadow-special hover:bg-white cursor-pointer ease-out duration-200">
