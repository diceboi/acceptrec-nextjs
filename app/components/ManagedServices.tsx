        ...
        <section className="flex flex-col w-11/12 lg:w-8/12  gap-8 py-20 m-auto">
            ...
            <div className='grid grid-cols-6 max-w-full h-[60vh] text-white'>
                <div className='group relative flex flex-col justify-center gap-8 w-full hover:-mt-8 hover:w-[150%] hover:-ml-[25%] hover:z-20 hover:rounded-3xl h-full p-4 bg-[url("/consulting.webp")] bg-cover bg-center bg-no-repeat transition-all duration-500'>
                    ...
                    <TbCalendarStats className='absolute top-4 left-4 w-8 h-8 text-[#00afaa] z-10 text-center opacity-100 group-hover:opacity-0 transition-all duration-500' />
                    <h3 className='absolute top-16 left-4 z-10 font-black text-2xl uppercase opacity-100 group-hover:opacity-0 transition-all duration-500'>Consultancy</h3>
                    <p className='z-10 opacity-0 group-hover:opacity-100 transition-all duration-500'>Removing the shortcomings that can expose your company to significant business, financial, and public relations risks.</p>
                </div>
                <div className='group relative flex flex-col justify-center gap-8 w-full hover:-mt-8 hover:w-[150%] hover:-ml-[25%] hover:z-20 hover:rounded-3xl h-full p-4 bg-[url("/contingent.webp")] bg-cover bg-center bg-no-repeat transition-all duration-500'>
                    <div className='absolute top-0 right-0 w-full h-full bg-[#312252] bg-opacity-50 group-hover:bg-opacity-75 group-hover:rounded-3xl transition-all duration-500'></div>
                    <TbClipboardData className='absolute top-4 left-4 w-8 h-8 text-[#00afaa] z-10 text-center opacity-100 group-hover:opacity-0 transition-all duration-500' />
                    <h3 className='absolute top-16 left-4 z-10 font-black text-2xl uppercase opacity-100 group-hover:opacity-0 transition-all duration-500'>Contingent Workforce Solutions</h3>
                ...
                <div className='group relative flex flex-col justify-center gap-8 w-full hover:-mt-8 hover:w-[150%] hover:-ml-[25%] hover:z-20 hover:rounded-3xl h-full p-4 bg-[url("/outsourcing.webp")] bg-cover bg-center bg-no-repeat transition-all duration-500'>
                    <div className='absolute top-0 right-0 w-full h-full bg-[#312252] bg-opacity-50 group-hover:bg-opacity-75 group-hover:rounded-3xl transition-all duration-500'></div>
                    <TbGraph className='absolute top-4 left-4 w-8 h-8 text-[#00afaa] z-10 text-center opacity-100 group-hover:opacity-0 transition-all duration-500' />
                    <h3 className='absolute top-16 left-4 z-10 font-black text-2xl uppercase opacity-100 group-hover:opacity-0 transition-all duration-500'>Recruitment Process Outsourcing</h3>
                ...
                <div className='group relative flex flex-col justify-center gap-8 w-full hover:-mt-8 hover:w-[150%] hover:-ml-[25%] hover:z-20 hover:rounded-3xl h-full p-4 bg-[url("/traning.webp")] bg-cover bg-center bg-no-repeat transition-all duration-500'>
                    <div className='absolute top-0 right-0 w-full h-full bg-[#312252] bg-opacity-50 group-hover:bg-opacity-75 group-hover:rounded-3xl transition-all duration-500'></div>
                    <TbUserUp className='absolute top-4 left-4 w-8 h-8 text-[#00afaa] z-10 text-center opacity-100 group-hover:opacity-0 transition-all duration-500' />
                    <h3 className='absolute top-16 left-4 z-10 font-black text-2xl uppercase opacity-100 group-hover:opacity-0 transition-all duration-500'>Training & Development Support</h3>
                ...
                <div className='group relative flex flex-col justify-center gap-8 w-full hover:-mt-8 hover:w-[150%] hover:-ml-[25%] hover:z-20 hover:rounded-3xl h-full p-4 bg-[url("/payment.webp")] bg-cover bg-center bg-no-repeat transition-all duration-500'>
                    <div className='absolute top-0 right-0 w-full h-full bg-[#312252] bg-opacity-50 group-hover:bg-opacity-75 group-hover:rounded-3xl transition-all duration-500'></div>
                    <TbReportMoney className='absolute top-4 left-4 w-8 h-8 text-[#00afaa] z-10 text-center opacity-100 group-hover:opacity-0 transition-all duration-500' />
                    <h3 className='absolute top-16 left-4 z-10 font-black text-2xl uppercase opacity-100 group-hover:opacity-0 transition-all duration-500'>Payroll Support</h3>
                ...
                <div className='group relative flex flex-col justify-center gap-8 w-full hover:-mt-8 hover:w-[150%] hover:-ml-[25%] hover:z-20 hover:rounded-3xl h-full p-4 bg-[url("/vendor.webp")] bg-cover bg-center bg-no-repeat transition-all duration-500'>
                    <div className='absolute top-0 right-0 w-full h-full bg-[#312252] bg-opacity-50 group-hover:bg-opacity-75 group-hover:rounded-3xl transition-all duration-500'></div>
                    <TbSquareRoundedNumber1 className='absolute top-4 left-4 w-8 h-8 text-[#00afaa] z-10 text-center opacity-100 group-hover:opacity-0 transition-all duration-500' />
                    <h3 className='absolute top-16 left-4 z-10 font-black text-2xl uppercase opacity-100 group-hover:opacity-0 transition-all duration-500'>Master Vendor</h3>
