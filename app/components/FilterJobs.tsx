    ...
    <>
        <section className="flex justify-center items-center w-full">
            <div className="flex flex-col lg:flex-row w-11/12 lg:w-8/12 gap-16 py-8">
                <div className="w-11/12 lg:w-1/2 h-[60vh] bg-[url('/easyfilter.webp')] bg-contain bg-center bg-no-repeat"></div>
                <div className="w-11/12 lg:w-1/2 flex justify-center flex-col gap-8">
                    <h3 className='text-sm lg:text-lg font-medium tracking-widest uppercase'>
                        Job filtering
                    </h3>
                    <h1 className="text-5xl font-black tracking-tighter ">Find your ideal job with ease</h1>
                    <p className="text-lg">
