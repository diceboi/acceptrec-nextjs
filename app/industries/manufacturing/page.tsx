...
export default function Manufacturing() {
  return (
    <>
        <section className="relative h-[50vh] pb-10 bg-[url('/manufacturing.webp')] bg-cover bg-center bg-no-repeat ">
            ...
            <div className="relative flex flex-col justify-between gap-4 w-11/12 lg:w-8/12 h-[50vh] m-auto ">
                ...
                <h1 className="text-5xl lg:text-8xl font-black tracking-tighter text-center">Manufacturing</h1>
                </div>
            </div>             
        </section>
        <section className='flex justify-center items-center w-full'>
            <div className='flex flex-col lg:flex-row gap-8 lg:gap-20 w-11/12 lg:w-8/12 py-20'>
                <div className="lg:w-1/2 min-h-[50vh] bg-[url('/manufacturing-inner.webp')] bg-cover bg-center bg-no-repeat rounded-3xl">
                </div>
                <div className="flex flex-col lg:w-1/2 gap-8">
                <h3 className='text-5xl font-black tracking-tighter'>Production, Operations, QA, Support and Maitenance</h3>
                <p>We recognise that optimising your manufacturing processes can pose some of the most challenging tasks in your business.</p>
                </div>
            </div>
        </section>
        ...
        <section className="flex flex-col lg:flex-row w-11/12 lg:w-8/12  gap-8 py-20 m-auto">
                <div className="flex flex-col gap-4 w-full lg:w-1/2 justify-start lg:bg-[url('/helping-hands.webp')] bg-contain bg-left bg-no-repeat">
                    ...
                    <h2 className="flex gap-3 text-5xl lg:text-6xl font-black tracking-tighter z-10 ">
                        Manufacturing jobs
                    </h2>
                    <p>
