    ...
    <>
        <section className="relative h-[50vh] pb-10 bg-[url('/manufacturing.webp')] bg-cover bg-center bg-no-repeat ">
            ...
            <div className="relative flex flex-col justify-between gap-4 w-11/12 lg:w-8/12 h-[50vh] m-auto ">
                ...
                <h1 className="text-6xl lg:text-8xl font-black tracking-tighter text-center">Manufacturing</h1>
                </div>
            </div>             
        </section>
        <section className='flex justify-center items-center w-full'>
            <div className='flex gap-20 w-11/12 lg:w-8/12 py-20 min-h-[50vh]'>
                <div className="w-1/2 bg-[url('/manufacturing-inner.webp')] bg-cover bg-center bg-no-repeat rounded-3xl">
                </div>
