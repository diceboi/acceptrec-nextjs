...
export async function generateMetadata() {
  return {
    ...
    alternates: {
      canonical: `https://www.acceptrec.co.uk/our-locations/tamworth-recruitment`
    }
  };
}
...
export default async function TamworthOfficePage() {
  ...
  return (
    <>
      ...
      <Office phonenumber={"01162182133"} about={""} living={""} jobs={""} coordinates={"52.634399938905744,-1.7008615349342602"}/>
    </>
  );
}
