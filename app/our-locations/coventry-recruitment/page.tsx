...
export async function generateMetadata() {
  return {
    ...
    alternates: {
      canonical: `/our-locations/coventry-recruitment`
    }
  };
}
...
export default async function OfficesPage() {
  ...
  // LocalBusiness schema for Coventry office
  const coventrySchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": "https://acceptrec.co.uk/our-locations/coventry-recruitment",
    "name": "Accept Recruitment - Coventry Office",
    "image": "https://acceptrec.co.uk/coventryofficehero.webp",
    "url": "https://acceptrec.co.uk/our-locations/coventry-recruitment",
    ...
    "geo": {
      "@type": "GeoCoordinates",
      "latitude": 52.40780950750115,
      "longitude": -1.4972240772632108
    },
    "aggregateRating": {
